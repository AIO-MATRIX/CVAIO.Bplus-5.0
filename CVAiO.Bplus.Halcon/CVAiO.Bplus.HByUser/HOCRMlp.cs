...
namespace CVAiO.Bplus.HByUser
{
    ...
    public class HOCRMlp : ToolBase
    {
        ...
        public override void Run()
        {
            ...
            try
            {
                ...
                foreach (ConnectedComponents.Blob blob in Blobs)
                {
                    ...
                    Halcon.HOperatorSet.DoOcrSingleClassMlp(character, hImage, RunParams.OcrHandle, 1, out classVal, out confidence);
        ...
        public override void Dispose()
        {
            ...
            Halcon.HOperatorSet.ClearOcrClassMlp(RunParams.OcrHandle);
        }
    }
    ...
    public class HOCRMlpRunParams : RunParams, ISerializable
    {
        ...
        #region Properties
        [Description("Ocr Classifier - omc format"), Category("HOCRMPL"), PropertyOrder(30)]
        ...
        public HTuple OcrHandle
        {
            get
            {
                if (ocrHandle == null)
                {
                    ...
                    Halcon.HOperatorSet.ReadOcrClassMlp(ocrClassifier, out ocrHandle);
                }
                return ocrHandle;
            }
            set => ocrHandle = value;
