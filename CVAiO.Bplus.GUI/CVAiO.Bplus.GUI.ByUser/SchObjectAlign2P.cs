...
{
    [Serializable]
    public class SchObjectAlign2P : SchedulerBase
    {
        public SchObjectAlign2P()
        {
        ...
        public override bool Do_WriteResult()
        {
            ...
            try
            {
                ...
                IFCommunication.ComData.WriteValue((int)IFCommunication.DataAddr + 4, (float)(AlgorithmTool as AlgoObjectAlign2P).AlgoPosition.X);
                IFCommunication.ComData.WriteValue((int)IFCommunication.DataAddr + 6, (float)(AlgorithmTool as AlgoObjectAlign2P).AlgoPosition.Y);
                IFCommunication.ComData.WriteValue((int)IFCommunication.DataAddr + 8, (float)(AlgorithmTool as AlgoObjectAlign2P).AlgoPosition.ThetaRad);
                // End code here
                return true;
            }
            catch (Exception ex)
        ...
        public override bool Do_Finalization()
        {
            ...
            try
            {
                ...
                list.Add((float)(AlgorithmTool as AlgoObjectAlign2P).AlgoPosition.X);
                list.Add((float)(AlgorithmTool as AlgoObjectAlign2P).AlgoPosition.Y);
                list.Add((float)((AlgorithmTool as AlgoObjectAlign2P).AlgoPosition.ThetaRad));
